...
for fl in $(find Contents/Resources/couchbase-core/bin Contents/Resources/couchbase-core/lib -perm +111 -type f -or -type l); do codesign $sign_flags  --sign "Developer ID Application: Couchbase, Inc" $fl ; done
cd ..
